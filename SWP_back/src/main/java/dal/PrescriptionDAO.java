...
public class PrescriptionDAO {
    ...
    public ArrayList<PrescriptionDTO> getAllPrescriptions(int page, int size, String status) {
        ...
        try {
            ...
            while (rs.next()) {
                l.add(new PrescriptionDTO(
                        rs.getInt("prescription_id"),
                        rs.getDate("prescription_date"),
                        rs.getNString("status"),
                        rs.getNString("patient_name"),
                        rs.getNString("patient_phone"),
                        rs.getNString("doctor_name"),
                        rs.getNString("doctor_department"),
                        rs.getNString("doctor_phone")
                ));
            }
            rs.close();
            ps.close();
